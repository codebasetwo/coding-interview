...
class ChallengeService:
    async def get_challenge_quota(self, session: AsyncSession, user_id: str) -> ChallengeQuota:
    ...
    async def create_challenge_quota(self, session: AsyncSession, user_id: str)-> ChallengeQuota:
    ...
    async def reset_quota_if_needed(self, session: AsyncSession, quota: ChallengeQuota) -> ChallengeQuota:
        now = datetime.now()
    ...
    async def get_user_challenges(self, session: AsyncSession, user_id: str) -> Challenge:
